...
Originally developed as a study project for an advanced C++ class, **miceFast** combines low-level optimizations and an object-oriented design to streamline multiple imputation workflows. 
