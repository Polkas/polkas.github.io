...
- Popular services (e.g. [cranlogs badges](https://cranlogs.r-pkg.org/)) measure only the RStudio/Posit CRAN mirror logs ([http://cran.rstudio.com](http://cran.rstudio.com) / [http://cran-logs.rstudio.com](http://cran-logs.rstudio.com)).
...
- There is most probably around 200-300 downloads a month on Posit/RStudio CRAN mirror which comes from servers rather than users. Read more about it the in ['ThreeWiseMonkeys'](https://github.com/gpilgrim2670/ThreeWiseMonkeys) R package README file.
...
CRAN is a network of mirrors. There’s no single authoritative counter across all mirrors, binary caches, containers, or corporate pipelines. 
What’s widely used instead:

- RStudio/Posit CRAN mirror logs: [http://cran-logs.rstudio.com](http://cran-logs.rstudio.com)
- Aggregated API and badges: [https://cranlogs.r-pkg.org](https://cranlogs.r-pkg.org)
...
FYI. The is a problem of ghost downloads on Posit CRAN mirror which was recognized by 'ThreeWiseMonkeys' R package author. 'ThreeWiseMonkeys' was created to recogize the servers baseline downloads on Posit CRAN mirror. By using ['ThreeWiseMonkeys'](https://github.com/gpilgrim2670/ThreeWiseMonkeys) as reference we can estimate that there is around 200-300 downloads a month which not comes from RStudio users but rather servers.
...
- cranlogs badges and API: [https://cranlogs.r-pkg.org/](https://cranlogs.r-pkg.org/)
- Daily mirror logs (RStudio/Posit CRAN mirror): [http://cran-logs.rstudio.com/](http://cran-logs.rstudio.com/)
