...
**TL;DR**  
Explains residual analysis in generalized linear models (GLMs), particularly logistic (binary outcomes) and Poisson (count outcomes). Using R, we clearly introduce raw, Pearson, deviance, and quantile residuals and illustrate how residual diagnostics can help verify model assumptions and identify potential misspecifications.
...
hist(raw_res, main="Logistic Raw Residuals", col="lightgreen", xlab="Raw Residuals")
```
...
hist(raw_res, main="Poisson Raw Residuals", col="lightgreen", xlab="Raw Residuals")
```
