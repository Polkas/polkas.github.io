...
Deploying r shiny rdevdash app to Digital Ocean
</a>
```
...
You can run examples or experiment with `docker` directly.  
...
The image for the rdevdash app is available on the docker hub `polas/rdevdash-app`. It is based on such Dockerfile:
