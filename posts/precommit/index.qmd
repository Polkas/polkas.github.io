...
For R projects:  
- **Install the precommit package from CRAN**:
   ```R
...
- **Run hooks manually** (optional): While pre-commit hooks automatically run on each commit, you can manually trigger them using:
   ```bash
